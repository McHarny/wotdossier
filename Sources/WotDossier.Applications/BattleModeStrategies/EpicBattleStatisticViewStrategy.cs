...
{
    public class EpicBattleStatisticViewStrategy : StatisticViewStrategyBase
    {
        ...
        public EpicBattleStatisticViewStrategy(DossierRepository dossierRepository)
        ...
        {
            return new EpicBattleBattlesTankStatisticRowViewModel(currentStatistic, prevStatisticViewModels);
        }
        ...
        {
            return new EpicBattleBattlesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic);
        }
        ...
        {
            return new EpicBattleBattlesPlayerStatisticViewModel((RandomBattlesStatisticEntity)currentStatistic, oldStatisticEntities);
        }
        ...
        public override PlayerEntity UpdatePlayerStatistic(int playerId, List<TankJson> tanks, Player serverStatistic)
        {
            ...
            var newSnapshot = new EpicBattleBattlesStatAdapter(tanks);
